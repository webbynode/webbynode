  ...
  module Commands
    ...
    class Remote
      ...
      def run
        ...
        raise Webbynode::ApplicationNotDeployed, "Before being able to run commands from your Webby, you must first push it." unless remote_executor.application_exists?
