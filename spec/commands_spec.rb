...
describe Webbynode::Commands do
  describe "init" do
    ...
    it "should translate the webby name into an IP" do
      wn = Webbynode::Application.new("init", "sandbox", "test.webbynodeqwerty.com")
      wn.should_receive(:webby_ip).with("sandbox").and_return("1.2.3.4")
      wn.should_receive(:git_init).with('1.2.3.4', 'test.webbynodeqwerty.com')
      wn.execute
    end
